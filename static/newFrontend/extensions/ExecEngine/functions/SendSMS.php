...
function SendSMS ($phonenumber,$message){
	...
	ErrorHandling::addLog("ResponseCode: " . $sms->getResponseCode());
	ErrorHandling::addLog("ResponseMessage: " . $sms->getResponseMessage());
	ErrorHandling::addLog("Balance: " . $sms->getCreditBalance());
}
