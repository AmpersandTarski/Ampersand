...
angular.module('AmpersandApp')
.controller('AtomicPasswordController', ["$scope", "ResourceService", function($scope, ResourceService){
...
angular.module('AmpersandApp')
.controller('InstallerController', ["$scope", "Restangular", "NotificationService", "RoleService", "NavigationBarService", function ($scope, Restangular, NotificationService, RoleService, NavigationBarService) {
