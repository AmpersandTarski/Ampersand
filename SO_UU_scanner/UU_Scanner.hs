...
ikeywordsops       = [ "|-", "-", "->", "<-", ">", "=", "~", "+", "*", ";", "!", "#", "::", ":", "\\/", "/\\", "\\", "/", "<>"
                    , "..", "." , "0", "1"]
ispecialchars :: String
ispecialchars      = "()[],{}"
iopchars :: String
iopchars           = nub (sort (concat ikeywordsops))
...
runScan :: String -> [Token]
runScan input = scan ikeywordstxt ikeywordsops ispecialchars iopchars "dummy.adl" (Pos 0 0) input
