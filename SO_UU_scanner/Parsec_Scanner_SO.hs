...
--module Database.Design.Ampersand.Input.ADL1.Parsec_Scanner_SO Version to restore if SO version is ok
module Parsec_Scanner_SO
         ( scan,initPos,Pos(..)
...
--import Database.Design.Ampersand.Input.ADL1.UU_BinaryTrees(tab2tree,btLocateIn) --to restore after SO version is ok
...
pExpl, pInteger10, pVarid, pConid, pInteger :: IsParser p Token => p String
