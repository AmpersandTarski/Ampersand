...
fSpec2Pandoc fSpec flags = ( myDoc , pictures )
  where 
    ...
    cpt2Blocks NatLangReqs         = chpNatLangReqs 0 -- Han, hier krijg ik hetzelfde hoofdstuk als SharedLang. Dat vindt LaTeX trouwens helmaal niet leuk...
    cpt2Blocks SharedLang          = chpNatLangReqs 0 -- Han, hier krijg ik hetzelfde hoofdstuk als NatLangReqs. Dat vindt LaTeX trouwens helmaal niet leuk...
