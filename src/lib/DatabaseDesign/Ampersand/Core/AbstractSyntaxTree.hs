...
data A_Context
   = ACtx{ ctxnm :: String           -- ^ The name of this context
         ...
         , ctxpopus :: [Population]  -- ^ The populations of relations defined in this context, including those from patterns and processes
...
data Relation = 
  Rel { relnm :: String           -- ^ the name of the relation. This is the same name as the name of reldcl.
      ...
      , relps  :: Population       -- ^ the population of the relation.
      } |
