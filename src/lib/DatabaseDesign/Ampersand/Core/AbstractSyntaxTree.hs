...
data A_Context
   = ACtx{ ctxnm :: String           -- ^ The name of this context
         ...
         , ctxks :: [IndexDef]         -- ^ The index definitions defined in this context, outside the scope of patterns
...
data Process = Proc { prcNm :: String
                    ...
                    , prcIxs :: [IndexDef]            -- ^ The index definitions defined in this process
...
data Pattern
   = A_Pat { ptnm :: String         -- ^ Name of this pattern
           ...
           , ptixs :: [IndexDef]      -- ^ The index definitions defined in this pattern
...
data RuleOrigin = UserDefined     -- This rule was specified explicitly as a rule in the Ampersand script
                ...
                | Index             -- This rule follows implicitly from the Ampersand script (Because of a index) and generated by a computer
                deriving (Show, Eq)
data Rule =
...
data Declaration = 
 ...
 --     , decpopu :: Pairs      -- ^ the list of tuples, of which the relation consists.
      ...
      , decusrX :: Bool       -- ^ if true, this relation is declared in the Ampersand script; otherwise it was generated by Ampersand.
...
data IndexDef = Ix { ixPos :: Origin        -- ^ position of this definition in the text of the Ampersand source file (filename, line number and column number).
                 , ixLbl :: String        -- ^ the name (or label) of this Index. The label has no meaning in the Compliant Service Layer, but is used in the generated user interface. It is not an empty string.
                 , ixCpt :: A_Concept     -- ^ this expression describes the instances of this object, related to their context
                 , indexAts :: [IndexSegment]  -- ^ the constituent attributes (i.e. name/expression pairs) of this index.
                 } deriving (Eq,Show)
instance Identified IndexDef where
  name = ixLbl
instance Traced IndexDef where
  origin = ixPos

data IndexSegment = IndExp ObjectDef deriving (Eq, Show)  -- TODO: refactor to a list of terms
