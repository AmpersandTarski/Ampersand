...
-- \***********************************************************************
   ...
   instance ShowHS Expression where
    ...
    showHS flags indent (ELrs (l,r) c sgn) = "ELrs ( "++showHS flags (indent++"       ") l++indent++"     , "++showHS flags (indent++"       ") r++indent++"     ) "++showHS flags "" c ++" ("++showHS flags "" sgn++")"
    showHS flags indent (ERrs (l,r) c sgn) = "ERrs ( "++showHS flags (indent++"       ") l++indent++"     , "++showHS flags (indent++"       ") r++indent++"     ) "++showHS flags "" c ++" ("++showHS flags "" sgn++")"
    showHS flags indent (ECps (l,r) c sgn) = "ECps ( "++showHS flags (indent++"       ") l++indent++"     , "++showHS flags (indent++"       ") r++indent++"     ) "++showHS flags "" c ++" ("++showHS flags "" sgn++")"
    showHS flags indent (ERad (l,r) c sgn) = "ERad ( "++showHS flags (indent++"       ") l++indent++"     , "++showHS flags (indent++"       ") r++indent++"     ) "++showHS flags "" c ++" ("++showHS flags "" sgn++")"
