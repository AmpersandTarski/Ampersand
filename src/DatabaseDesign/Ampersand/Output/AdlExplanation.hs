...
class  Identified a => Explainable a where 
  purpose :: Fspc -> Lang -> a -> Maybe Purpose -- ^ explains the purpose of a, i.e. the reason why a exists. The purpose could be either given by the user, or generated by Ampersand. 
  purpose fSpec l x = case expls of
                        ...
                        [e]  -> Just e
                        _    -> fatal 42 ("Too many purposes given for " ++show (name x))
