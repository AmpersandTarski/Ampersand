...
where
import DatabaseDesign.Ampersand.Core.Basics  (eqCl,Collection (..),upCap, commaNL, commaEng, preciesEen)
    ...
    where meta = Meta titl authors date
          ...
          authors = case (language flags) of
                         ...
                         English -> [[Str "Put author(s) here"]
                                    ,[Str ("(This document was generated by "++ampersandCoreVersionBanner++")")]]
