...
versionNumberPrototype = "1.1.0.869" -- #1.#2.#3.#4 : #1 major version; #2 student release version; #3 production fix version (normally 0 ); #4 SVN revision number.
{-
SVN Version text:
Upgraded Pandoc to version 1.8.0.1
