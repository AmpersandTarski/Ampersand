...
versionNumberPrototype = "2.0.1.912" -- #1.#2.#3.#4 : #1 major version; #2 student release version; #3 production fix version (normally 0 ); #4 SVN revision number.
{-
SVN Version text:
TICKET #60 fixed. 
This version is compilable with Ampersand vs. 2.1.0.42
-}
