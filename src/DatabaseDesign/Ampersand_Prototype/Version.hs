...
versionNumberPrototype = "1.1.0.903" -- #1.#2.#3.#4 : #1 major version; #2 student release version; #3 production fix version (normally 0 ); #4 SVN revision number.
{-
SVN Version text:
ticket #10: work in progress
This version is compilable with Ampersand vs. 2.0.0.33
-}
