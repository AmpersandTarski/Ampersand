...
-- The expressions generated by genTerm must be of type TermPrim.
-- The parser doesn't expect anything else.
-- Therefore we cannot declare the generic instance:
--      instance Arbitrary a => Arbitrary (Term a)
-- So we declare a separate function that generates Term TermPrim instead of Term a:
