...
data Rule = Rule
  { -- | Name of this rule
    ...
    -- | If the rule is defined in the context of a pattern, the name that identifies the pattern
    rrpat :: !(Maybe Name),
...
data IdentityRule = Id
  { -- | The position of this definition in the text of the Ampersand source file (filename, line number and column number).
    ...
    idCpt :: !A_Concept,
    -- | if defined within a pattern, then the name that identifies that pattern.
    idPat :: !(Maybe Name),
