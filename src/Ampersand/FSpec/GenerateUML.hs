...
genCustomReqElements :: (HasOutputLanguage env) => env -> FSpec -> String -> UML
  ...
  where
    ...
    reqUML (xmiId, req) = L.intercalate "\n"
     ([ "    <element xmi:idref="++show xmiId++" xmi:type=\"uml:Requirement\" name="++show (reqId req)++" scope=\"public\""++">"
      ...
      , "      <properties documentation="++show (maybe "" aMarkup2String (fmap ameaMrk . meaning (outputLang env fSpec) $ req))++" isSpecification=\"false\" sType=\"Requirement\" nType=\"0\" scope=\"public\" stereotype=\"Functional\"/>"
      , "      <tags>"]++
