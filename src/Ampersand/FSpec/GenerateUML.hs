...
fSpec2UML env fSpec =
  do
    ...
    return
      $ [ "<?xml version=\"1.0\" encoding=\"UTF-8\"?>", -- The following XMI-template has been borrowed from Enterprise Architect vs. 6.5
      ...
      do
        ...
        return
          [ "     <memberEnd xmi:idref=\"" <> endId <> "\"/>",
            "     <ownedEnd xmi:type=\"uml:Property\" xmi:id=\""
              <> endId
              <> "\" visibility=\"public\" association=\""
              <> assocId
              <> "\" isStatic=\"false\""
