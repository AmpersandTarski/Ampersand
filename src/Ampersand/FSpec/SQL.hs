    ...
    where
      ...
      insertPlaceholder bqe =
        ...
        where
          ...
          placeHolder = BinOp (col2ValueExpr (bseSrc bqe)) [uName "="] (stringLit placeHolderSQL)
          ...
          case expr2 of
            EDcD rel ->
              let (plug, relstore) = getRelationTableInfo fSpec rel
                  s = qName . attName . rsSrcAtt $ relstore
                  t = qName . attName . rsTrgAtt $ relstore
                  ...
                  mandatoryTuple =
                    ...
                    where
                      ...
                      equalToValueClause singleton =
                        conjunctSQL
                          [ BinOp (col2ValueExpr theSr') [uName "="] (singleton2SQL (source expr) singleton),
                            BinOp (col2ValueExpr theTr') [uName "="] (singleton2SQL (source expr) singleton)
                          ]
