...
data ColorMode
  = -- | Terminal output will never be coloured.
    Never
  | -- | Terminal output will always be coloured.
    Always
  | -- | Terminal output will be coloured if $TERM and stdout appear to support it.
    Auto
