...
data Lexeme  = LexSymbol      Char    -- ^ A symbol
             ...
             | LexIdentifier  String  -- ^ An identifier starts with a letter and may subsequently contain letters, digits, and underscores
...
instance Show Lexeme where
    show x = case x of
         ...
         LexIdentifier val -> "identifier "            ++              val
