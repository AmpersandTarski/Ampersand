module.exports = {
    ...
    ampersandReferenceSidebar: [
        // This is for all documentation from the Ampersand repo that should go in the `Reference material` part of the menu. 
        {
            ...
            type: 'category',
            items: [
                'reference-material/syntax-of-ampersand/the-concept-statement',
                'reference-material/syntax-of-ampersand/the-context-statement',
                'reference-material/syntax-of-ampersand/the-classify-statement',
                'reference-material/syntax-of-ampersand/the-enforce-statement',
                'reference-material/syntax-of-ampersand/the-ident-statement',
                'reference-material/syntax-of-ampersand/the-include-statement',
                'reference-material/syntax-of-ampersand/the-meaning-substatement',
                'reference-material/syntax-of-ampersand/the-population-statement',
                'reference-material/syntax-of-ampersand/the-purpose-statement',
                'reference-material/syntax-of-ampersand/the-relation-statement',
                'reference-material/syntax-of-ampersand/the-rule-statement',
            ]
        },
