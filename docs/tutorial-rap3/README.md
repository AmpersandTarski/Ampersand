...
2. Then you will be introduced to the web-based version of Ampersand, [RAP](your-tool-rap3.md)4, in which you can specify an information system and create a working web-based prototype. With this tool, you can make information systems of your own, enabling you to complete the course.
...
4. You will [learn how to analyse a "spreadsheet information system"](the-language-ampersand/syntactical-conventions/the-population-statement.md#population-in-spreadsheets) and turn it into a well defined information system. This technique allows you to help organizations with organizing and structuring data.
