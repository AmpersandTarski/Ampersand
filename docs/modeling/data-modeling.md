...
Since Ampersand works with [relations](../reference-material/syntax#the-relation-statement), it must represent this table as relations. Three relations can do the job in the following manner:
